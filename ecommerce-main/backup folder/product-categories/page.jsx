  ...
  const categories = [
    {
      ...
      description: "Focused on outdoor electrical safety, waterproof protection & reliability.",
      image: "https://images.unsplash.com/photo-1581092335878-5c8c7f4a4c8d?w=400&h=300&fit=crop",
      applications: ["Manufacturing & Engineering", "Oil, Gas & Utilities"],
      productRange: ["Weatherproof  Enclosures", "Outdoor Enclosures"]
    },
    {
      id: 2,
      title: "Infrastructure Projects",
      description: "Durable protection systems for large-scale infrastructure development",
      image: "https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=400&h=300&fit=crop",
      applications: ["Construction & Infrastructure", "Energy & Power"],
      productRange: ["Industrial Plugs & Sockets", "Solar & Power Distribution Solutions"]
    },
    {
      id: 3,
      title: "Solar Power Plants",
      description: "Specialized enclosures for photovoltaic installations and renewable energy systems",
      image: "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=400&h=300&fit=crop",
      applications: ["Renewable & Solar", "Energy & Power"],
      productRange: ["Solar & Power Distribution Solutions", "Weatherproof & Outdoor Enclosures"]
    },
    {
      id: 4,
      title: "Construction Sites",
      description: "Rugged enclosures designed for temporary and permanent construction applications",
      image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400&h=300&fit=crop",
      applications: ["Construction & Infrastructure", "Manufacturing & Engineering"],
      productRange: ["Industrial Socket Boxes & Panels", "Accessories & Components"]
    },
    {
      id: 5,
      title: "Commercial Buildings & Offices",
      description: "Professional enclosure solutions for commercial and office environments",
      image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400&h=300&fit=crop",
      applications: ["Commercial & Industrial Buildings"],
      productRange: ["Metal Enclosures & Boxes", "Industrial Plugs & Sockets"]
    },
    // {
    //   id: 6,
    //   title: "Renewable Energy Installations",
    //   description: "Advanced protection systems for wind, solar and other renewable energy projects",
    ...
    // {
    //   id: 7,
    //   title: "OEM & Panel Builders",
    //   description: "Customizable enclosures for original equipment manufacturers and panel builders",
    //   image: "https://images.unsplash.com/photo-1581092335878-2314dddb7ece?w=400&h=300&fit=crop",
    //   applications: ["Manufacturing & Engineering", "Automation & Control Systems"],
    //   productRange: ["Metal Enclosures & Boxes", "Accessories & Components"]
    // },
    // {
    //   id: 8,
    //   title: "Public Utilities & Street Lighting",
    //   description: "Reliable enclosures for public utilities and urban lighting infrastructure",
    //   image: "https://images.unsplash.com/photo-1533628635777-112b2239b1c7?w=400&h=300&fit=crop",
    //   applications: ["Oil, Gas & Utilities", "Transportation & Metro Projects"],
    //   productRange: ["Weatherproof & Outdoor Enclosures", "Industrial Socket Boxes & Panels"]
    // }
  ];
            ...
            >
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 group cursor-pointer transform hover:-translate-y-2 hover:rotate-1">
                ...
                <div className="p-6 relative">
                  ...
                  <p className="text-gray-600 text-sm mb-4 group-hover:text-gray-700 transition-colors duration-300">{category.description}</p>
