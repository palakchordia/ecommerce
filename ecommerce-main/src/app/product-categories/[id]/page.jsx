        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 sm:gap-6">
            {category.relatedProducts.map((product, index) => (
              <Link
                key={index}
                href={`/product-categories/${categoryId}/product/${index}`}
                className="block bg-gray-50 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 group"
              >
                {/* Product Image */}
                <div className="relative h-40 sm:h-48 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1581092335878-5c8c7f4a4c8d?w=300&h=200&fit=crop"
                    alt={product.name}
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="pt-2 border-t border-gray-200">
                    <span className="block w-full text-left text-red-600 hover:text-red-700 font-medium text-sm transition-colors duration-300">
                      View Details →
                    </span>
                  </div>
                </div>
