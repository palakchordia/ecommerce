...
const ProductDetailPage = () => {
  ...
  const product = category?.relatedProducts[productId];
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center px-4">
            ...
            <Link href={`/product-categories/${categoryId}`} className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors inline-block">
              Back to Category
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Breadcrumb */}
      <div className="bg-gray-100 py-3 sm:py-4 md:hidden">
        <div className="max-w-7xl mx-auto px-4">
          <nav className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm">
            ...
            <span className="text-gray-500">/</span>
            <Link href={`/product-categories/${categoryId}`} className="text-red-600 hover:underline whitespace-nowrap ">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 text-center">Key Features</h2>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 text-center">Technical Specifications</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {Object.entries(category.specifications).map(([key, value]) => (
              <div key={key} className="flex flex-col sm:flex-row sm:justify-between p-4 bg-gray-50 rounded-lg">
                <span className="font-semibold text-gray-700 mb-1 sm:mb-0">{key}:</span>
                <span className="text-gray-800 text-sm sm:text-base">{value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Product Gallery */}
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 text-center">Product Gallery</h2>
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg p-6 sm:p-8 text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl mb-4 sm:mb-6 opacity-90 leading-relaxed max-w-3xl mx-auto">
            Contact our experts for detailed specifications, pricing, and customization options for {product.name}
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-red-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-red-700 transition-colors font-semibold text-base sm:text-lg w-full sm:w-auto text-center min-h-[48px] flex items-center justify-center"
            >
              Request Quote
            </Link>
          </div>
